// --- MAIN CUSTOMERS SCREEN (Clean List + Modal) ---
...
export default function Customers() {
  ...
  const { BottomSheetBackdrop } = require("@gorhom/bottom-sheet");
...
function createStyles(theme: Theme) {
  ...
  return StyleSheet.create({
    ...
    modalSafe: { flex: 1, backgroundColor: colors.background, padding: spacing.md },

    // ✅ NEW: Bottom Sheet Content styling
    sheetContent: {
      flex: 1,
      padding: spacing.xl,
      gap: spacing.sm,
